...
- [입력 액션 계약](Docs/07_INPUT_ACTIONS.md)
- [카메라 기준 플레이어 이동](Docs/08_PLAYER_MOVEMENT.md)
- [Cinemachine 3인칭 카메라](Docs/09_THIRD_PERSON_CAMERA.md)
- [카메라 장애물 가림 처리](Docs/10_CAMERA_OCCLUSION.md)
...
- 단계: M1 플레이어 조작 구현
- PRD와 OpenSpec: 버티컬 슬라이스 명세 유효, 작업 10/64 완료
- Unity 프로젝트: 6000.3.11f1 Universal 3D, M0 기반 검증 완료
- 구현 완료: 입력 액션, 카메라 기준 이동, Cinemachine 추적·회전·장애물 가림 처리
- 자동 검증: EditMode 19/19, PlayMode 7/7 통과
- 다음 작업: 일시정지·승리·패배 상태의 게임플레이 입력 차단
